...
class Sumo : BotBase("/play duels_sumo_duel") {
    ...
    fun onClientDamage() {
        if (mc.thePlayer.onGround) {
            Movement.singleJump(RandomUtils.randomIntInRange(10, 60))
    ...
    override fun onTick() {
        opponentOffEdge = opponent() != null && mc.thePlayer != null &&
                (WorldUtils.entityOffEdge(opponent()!!) || opponentOffEdge && EntityUtils.getDistanceNoY(mc.thePlayer, opponent()!!) > 17)
